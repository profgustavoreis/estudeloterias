...
import { ChevronDown, Menu, X, BarChart3, CalendarDays, Dices, Gift, HelpCircle, Home, Info, List, Sparkles, Target, Trophy } from "lucide-react";
...
const megaSenaItems = [
  ...
  { href: "/mega-sena/calendario", label: "Calendário de Sorteios", icon: CalendarDays, desc: "Próximas datas de sorteio" },
