...
function UltimaVezLink({ concurso }: { concurso: number | null }) {
  ...
  return (
    <Link href={`/diadesorte/resultado/${concurso}`} className="font-semibold hover:underline whitespace-nowrap" style={{ color: COR }}>
      Concurso {concurso} →
    </Link>
  );
}
...
export default function DiaDeSorteEstatisticasTabela() {
  ...
  return (
    <div className="space-y-6">
      ...
      <AffiliateCard
        ...
        moduleId="aff_diadesorte_tabela_de_dezenas"
