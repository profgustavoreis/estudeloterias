...
import { useGetDiadesorteEstatisticas } from "@workspace/api-client-react";
...
export default function DiaDeSorteEstatisticas() {
  const { data: stats, isLoading, isError } = useGetDiadesorteEstatisticas();
  ...
  if (isError || !stats) {
    return (
      <div className="space-y-6">
        <h1 className="text-3xl font-bold tracking-tight" style={{ color: COR }}>Dia de Sorte · Resumo Estatístico</h1>
        <Card>
  ...
  const MOLDURA_SET = new Set([
    ...
    ...Array.from({ length: 1 }, (_, i) => i + 31),
    11, 20, 21, 30,
  ]);
  const RETRATO_SET = new Set(
    Array.from({ length: 31 }, (_, i) => i + 1).filter(n => !MOLDURA_SET.has(n))
  );
  ...
  return (
    <div className="space-y-8">
      <PageSEO
        title="Resumo Estatístico do Dia de Sorte — Frequência e Análise das Dezenas"
        description="Análise estatística completa do Dia de Sorte: dezenas mais e menos sorteadas, pares, sequências, somas e muito mais baseado em todo o histórico de concursos."
        canonical="/diadesorte/resumo-estatistico"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
                  ...
                  {maisSorteadas.map((item, i) => (
                    <TableRow key={item.dezena} className="odd:bg-muted/40">
                      ...
                      <TableCell className="text-right">
                        {item.ultimoConcurso ? (
                          <Link
                            href={`/diadesorte/resultado/${item.ultimoConcurso}`}
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="/diadesorte/tabela-de-dezenas?tab=mais"
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="/diadesorte/tabela-de-dezenas?tab=menos"
                  className="text-sm font-semibold hover:underline"
                  style={{ color: COR }}
                >
                  Ver todas →
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="/diadesorte/tabela-de-dezenas?tab=atrasadas"
                  className="text-sm font-semibold hover:underline"
                  style={{ color: COR }}
                >
                  Ver todas →
                ...
                rows={stats.paresImpares
                  ...
                  .map(d => [
                    ...
                    totalSorteios > 0
                      ...
                      : "–",
                    d.ultimoConcurso
                      ? <Link href={`/diadesorte/resultado/${d.ultimoConcurso}`} className="font-semibold hover:underline whitespace-nowrap" style={{ color: COR }}>Concurso {d.ultimoConcurso} →</Link>
                      : "–",
                  ])}
              />
            </CardContent>
              ...
              <CardDescription>
                {stats.somaDezenas.menor && stats.somaDezenas.maior ? (
                  <>
                    ...
                    (
                    <Link
                      href={`/diadesorte/resultado/${stats.somaDezenas.menor.concurso}`}
                    ...
                    (
                    <Link
                      href={`/diadesorte/resultado/${stats.somaDezenas.maior.concurso}`}
                      className="font-semibold hover:underline"
                      style={{ color: COR }}
                    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Ocorrências acumuladas por faixa de dezenas (01–10, 11–20, 21–30, 31)
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Col. 1 = {"{"}01,11,21,31{"}"} … Col. 10 = {"{"}10,20,30{"}"}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[220px]">
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      content={({ active, payload }) => {
                        ...
                        const dezenas = [base, base + 10, base + 20]
                          .filter(n => n <= 31)
                          .map(n => String(n).padStart(2, "0"))
                          .join(", ");
                        return (
            ...
            <CardContent className="pt-5 space-y-5">
              <div className="flex flex-wrap gap-x-8 gap-y-1 text-sm">
                <div>
                  ...
                  <span className="font-semibold">{especial.quantidadeNaFaixa} dezenas entre 01 e 31</span>
                </div>
                <div>
