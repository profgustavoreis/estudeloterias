...
import { useGerarJogoLotofacil } from "@workspace/api-client-react";
import { Sparkles, Printer, RefreshCw } from "lucide-react";
import { PageSEO } from "@/components/seo/PageSEO";

const COR = "#930089";
const COR_HOVER = "#7a0070";

export default function LotofacilGerador() {
  ...
  const gerarJogo = useGerarJogoLotofacil({
  ...
  return (
    <div className="space-y-6">
      <PageSEO
        title="Gerador de Jogos da Lotofácil"
        description="Gere apostas aleatórias para a Lotofácil escolhendo quantos jogos e quantas dezenas por jogo. Surpresinha inteligente e gratuita."
        canonical="/lotofacil/gerador"
      />
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight" style={{ color: COR }}>Lotofácil · Gerador de Jogos</h1>
          <p className="text-muted-foreground mt-1">Crie jogos aleatórios baseados em parâmetros estatísticos.</p>
        </div>
      </div>
        ...
        <Card className="lg:col-span-1 h-fit">
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <Slider value={[qtdDezenas]} min={15} max={20} step={1} onValueChange={v => setQtdDezenas(v[0])} />
              <div className="text-xs text-muted-foreground">Aposta mínima: 15 dezenas (R$ 3,50). Máxima: 20 dezenas.</div>
            </div>
          </CardContent>
          <CardFooter>
            <Button
