import { useGetLotofacilCalendario } from "@workspace/api-client-react";
...
export default function LotofacilCalendario() {
  const { data: sorteios, isLoading, isError } = useGetLotofacilCalendario();
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight" style={{ color: COR }}>Lotofácil · Calendário de Sorteios</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {sorteios.map((sorteio, i) => {
          const isNext = i === 0;
          return (
            <Card key={i} className={isNext ? "shadow-md ring-1" : ""} style={isNext ? { borderColor: COR, ["--tw-ring-color" as string]: COR + "33" } : {}}>
              <CardHeader className="pb-4" style={isNext ? { backgroundColor: COR + "08" } : {}}>
