...
function UltimaVezLink({ concurso }: { concurso: number | null }) {
  ...
  return (
    <Link href={`/duplasena/resultado/${concurso}`} className="font-semibold hover:underline whitespace-nowrap" style={{ color: COR }}>
      Concurso {concurso} →
    </Link>
  );
}
...
export default function DuplasenaEstatisticasTabela() {
