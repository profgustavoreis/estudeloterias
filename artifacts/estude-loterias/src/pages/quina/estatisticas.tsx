...
import { useGetQuinaEstatisticas } from "@workspace/api-client-react";
...
// Quina 8×10 grid definitions
const MOLDURA_SET = new Set<number>([
  ...Array.from({ length: 10 }, (_, i) => i + 1),
  ...Array.from({ length: 10 }, (_, i) => i + 71),
...
// ── Main component ────────────────────────────────────────────────────────────
export default function QuinaEstatisticas() {
  const { data: stats, isLoading, isError } = useGetQuinaEstatisticas();
  ...
  if (isError || !stats) {
    return (
      <div className="space-y-6">
        <h1 className="text-3xl font-bold tracking-tight" style={{ color: COR }}>Quina · Resumo Estatístico</h1>
        <Card>
  ...
  return (
    <div className="space-y-8">
      ...
      <AffiliateCard
        ...
        moduleId="aff_ferramenta_quina_estatisticas"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
                  ...
                  {maisSorteadas.map((item, i) => (
                    <TableRow key={item.dezena} className="odd:bg-muted/40">
                      ...
                      <TableCell className="text-right">
                        {item.ultimoConcurso ? (
                          <Link
                            href={`/quina/resultado/${item.ultimoConcurso}`}
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="/quina/tabela-de-dezenas?tab=mais"
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="/quina/tabela-de-dezenas?tab=menos"
                  className="text-sm font-semibold hover:underline"
                  style={{ color: COR }}
                >
                  Ver todas →
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="/quina/tabela-de-dezenas?tab=atrasadas"
                  className="text-sm font-semibold hover:underline"
                  style={{ color: COR }}
                >
                  Ver todas →
                ...
                rows={stats.paresImpares
                  ...
                  .map(d => [
                    ...
                    totalSorteios > 0
                      ...
                      : "–",
                    d.ultimoConcurso
                      ? <Link href={`/quina/resultado/${d.ultimoConcurso}`} className="font-semibold hover:underline whitespace-nowrap" style={{ color: COR }}>Concurso {d.ultimoConcurso} →</Link>
                      : "–",
                  ])}
              />
            </CardContent>
            ...
            return (
              <Card>
                <CardHeader className="pb-3">
                  ...
                  <CardDescription>
                    Quantas dezenas do sorteio caem na borda (moldura) ou no interior (retrato) do volante 8×10?
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-[200px]">
              ...
              <CardDescription>
                {stats.somaDezenas.menor && stats.somaDezenas.maior ? (
                  <>
                    ...
                    (
                    <Link
                      href={`/quina/resultado/${stats.somaDezenas.menor.concurso}`}
                    ...
                    (
                    <Link
                      href={`/quina/resultado/${stats.somaDezenas.maior.concurso}`}
                      className="font-semibold hover:underline"
                      style={{ color: COR }}
                    >
      ...
      {/* ── Seção 3: Distribuição na Grade 8×10 ── */}
      <section className="space-y-3">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">
          Distribuição na Grade 8×10
        </h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Ocorrências acumuladas por linha do volante (L1 = 01–10, L2 = 11–20…)
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Col. 1 = {"{"} 01,11,...,71 {"}"} … Col. 10 = {"{"} 10,20,...,80 {"}"}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[220px]">
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      content={({ active, payload }) => {
                        ...
                        const dezenas = Array.from({ length: 8 }, (_, i) => d.coluna + i * 10)
                          .map(n => String(n).padStart(2, "0"))
                          .join(", ");
                        return (
                          <div className="bg-card border rounded shadow-md px-3 py-2 text-sm">
                  ...
                  <AccordionContent>
                    <div className="space-y-1 text-xs text-muted-foreground">
                      {Array.from({ length: 10 }, (_, i) => i + 1).map(col => {
                        const dezenas = Array.from({ length: 8 }, (_, j) => col + j * 10)
                          .map(n => String(n).padStart(2, "0"))
                          .join(", ");
                        return (
                          <div key={col}>
                ...
                <CardContent className="pt-5 space-y-5">
                  <div className="flex flex-wrap gap-x-8 gap-y-1 text-sm">
                    <div>
                      ...
                      <span className="font-semibold">{especial.quantidadeNaFaixa} dezenas entre 01 e 80</span>
                    </div>
                    <div>
