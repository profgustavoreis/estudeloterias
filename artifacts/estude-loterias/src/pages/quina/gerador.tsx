...
import { useGerarJogoQuina } from "@workspace/api-client-react";
import { Sparkles, Printer, RefreshCw } from "lucide-react";
import { PageSEO } from "@/components/seo/PageSEO";

const COR = "#260085";
const COR_HOVER = "#1a005c";

export default function QuinaGerador() {
  ...
  const gerarJogo = useGerarJogoQuina({
  ...
  return (
    <div className="space-y-6">
      <PageSEO
        title="Gerador de Jogos da Quina"
        description="Gere apostas aleatórias para a Quina escolhendo quantos jogos e quantas dezenas por jogo. Surpresinha inteligente e gratuita."
        canonical="/quina/gerador"
      />
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight" style={{ color: COR }}>Quina · Gerador de Jogos</h1>
        ...
        <Card className="lg:col-span-1 h-fit">
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <Slider value={[qtdDezenas]} min={5} max={15} step={1} onValueChange={v => setQtdDezenas(v[0])} />
              <div className="text-xs text-muted-foreground">Aposta mínima: 5 dezenas (R$ 3,00). Máxima: 15 dezenas.</div>
            </div>
          </CardContent>
          <CardFooter>
            <Button
