...
import { useGetMaismilionariaEstatisticas } from "@workspace/api-client-react";
...
function DezBadge({ n, active }: { n: number; active?: boolean }) {
  return (
    <span className={cn(
      ...
      active ? "bg-[#2E3078] text-white" : "bg-muted text-muted-foreground",
    )}>
...
// ── Main component ────────────────────────────────────────────────────────────
export default function MaismilionariaEstatisticas() {
  const { data: stats, isLoading, isError } = useGetMaismilionariaEstatisticas();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
                  ...
                  {maisSorteadas.map((item, i) => (
                    <TableRow key={item.dezena} className="odd:bg-muted/40">
                      ...
                      <TableCell className="text-right">
                        {item.ultimoConcurso ? (
                          <Link
                            href={`/maismilionaria/resultado/${item.ultimoConcurso}`}
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="/maismilionaria/tabela-de-dezenas?tab=mais"
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="/maismilionaria/tabela-de-dezenas?tab=menos"
                  className="text-sm font-semibold hover:underline"
                  style={{ color: COR }}
                >
                  Ver todas →
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-3 flex justify-end">
                <Link
                  href="/maismilionaria/tabela-de-dezenas?tab=atrasadas"
                  className="text-sm font-semibold hover:underline"
                  style={{ color: COR }}
                >
                  Ver todas →
                ...
                rows={stats.paresImpares
                  ...
                  .map(d => [
                    ...
                    totalSorteios > 0
                      ...
                      : "–",
                    d.ultimoConcurso
                      ? <Link href={`/maismilionaria/resultado/${d.ultimoConcurso}`} className="font-semibold hover:underline whitespace-nowrap" style={{ color: COR }}>Concurso {d.ultimoConcurso} →</Link>
                      : "–",
                  ])}
              />
            </CardContent>
              ...
              <CardDescription>
                {stats.somaDezenas.menor && stats.somaDezenas.maior ? (
                  <>
                    ...
                    (
                    <Link
                      href={`/maismilionaria/resultado/${stats.somaDezenas.menor.concurso}`}
                    ...
                    (
                    <Link
                      href={`/maismilionaria/resultado/${stats.somaDezenas.maior.concurso}`}
                      className="font-semibold hover:underline"
                      style={{ color: COR }}
                    >
