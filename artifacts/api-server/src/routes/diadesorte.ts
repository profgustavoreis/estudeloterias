...
router.get("/diadesorte/resultado/ultimo", async (req, res) => {
  try {
    ...
    logger.error({ err }, "Failed to get diadesorte ultimo resultado");
...
router.get("/diadesorte/resultados", async (req, res) => {
  try {
    ...
    logger.error({ err }, "Failed to get diadesorte resultados");
...
router.get("/diadesorte/resultados/:concurso", async (req, res) => {
  ...
  try {
    ...
    logger.error({ err, concurso }, "Failed to get diadesorte concurso");
...
router.get("/diadesorte/estatisticas", async (req, res) => {
  try {
    ...
    logger.error({ err }, "Failed to compute diadesorte estatisticas");
...
router.get("/diadesorte/resumo", async (req, res) => {
  try {
    ...
    logger.error({ err }, "Failed to get diadesorte resumo");
...
router.post("/diadesorte/simulador", async (req, res) => {
  try {
    ...
    logger.error({ err }, "Failed to simulate diadesorte");
...
router.post("/diadesorte/gerador", async (req, res) => {
  try {
    ...
    logger.error({ err }, "Failed to generate diadesorte jogo");
